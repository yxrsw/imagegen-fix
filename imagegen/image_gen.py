...
def main() -> int:
    ...
    gen_parser.add_argument('--max-attempts', type=int, default=1)
    ...
    batch_parser.add_argument("--max-attempts", type=int, default=1)
    ...
    edit_parser.add_argument('--max-attempts', type=int, default=1)
